    ...
    >
      <div className="container">
        <div className="about">
          <h3>About</h3>
          <p>
            We believe in the power of stories and ideas to inspire, inform, and connect people 
          ...
          <p>
            <span>Email:</span>questblogs@gmail.com
          </p>
          <p>
      ...
      <div className="container">
        <div className="logo">Quest<span>Blogs</span></div>
        <div className="links">
